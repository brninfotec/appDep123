...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Editprofile = __webpack_require__(8);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          null,
	          _react2.default.createElement(_reactRouterDom.Route, { path: '/', element: _react2.default.createElement(_Login2.default, null) }),
	          _react2.default.createElement(_reactRouterDom.Route, { path: '/signup', element: _react2.default.createElement(_Signup2.default, null) }),
	          _react2.default.createElement(_reactRouterDom.Route, { path: '/home', element: _react2.default.createElement(_Home2.default, null) }),
	          _react2.default.createElement(_reactRouterDom.Route, { path: '/Editprofile', element: _react2.default.createElement(_Editprofile2.default, null) })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Editprofile() {
	    ...
	    var firstNameinputRef = (0, _react.useRef)();
	    var lastNameinputRef = (0, _react.useRef)();
	    var passwordinputRef = (0, _react.useRef)();
	    var profilePicinputRef = (0, _react.useRef)();
	
	    var _useState = (0, _react.useState)("./images/pp.png"),
	        _useState2 = _slicedToArray(_useState, 2),
	        profilePic = _useState2[0],
	        setProfilePic = _useState2[1];
	    ...
	    var sendUpdatedDataToServer = function () {
	        var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
	            var dataToSend, i, reqOptions, JSONData, JSOData;
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        case 0:
	                            ...
	                            for (i = 0; i < profilePicinputRef.current.files.length; i++) {
	                            ...
	                            _context.next = 9;
	                            return fetch("/updateDetails", reqOptions);
	        ...
	        return function sendUpdatedDataToServer() {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { ref: profilePicinputRef, type: 'file', onChange: function onChange() {
	                        var selectedFileURL = URL.createObjectURL(profilePicinputRef.current.files[0]);
	            ...
	            _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('img', { className: 'profilePicPreview', src: profilePic })
	            ),
	            _react2.default.createElement(
	                'div',
	                null,
	                ...
	                _react2.default.createElement('input', { ref: firstNameinputRef })
	            ),
	            _react2.default.createElement(
	                'div',
	                null,
	                ...
	                _react2.default.createElement('input', { ref: lastNameinputRef })
	            ),
	            _react2.default.createElement(
	                'div',
	                null,
	                ...
	                _react2.default.createElement('input', { ref: passwordinputRef })
	            ),
	            _react2.default.createElement(
	                'button',
	                { type: 'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Home() {
	  ...
	  var deleteAccount = function () {
	    var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
	      var dataToSend, reqOptions, JSONData, JSOData;
	      return _regenerator2.default.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              _context.next = 5;
	              return fetch("/deleteUser", reqOptions);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement('img', { src: '/' + loc.state.data.profilePic })
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Login() {
	  ...
	  var emailinputRef = (0, _react.useRef)();
	  var passwordinputRef = (0, _react.useRef)();
	  var navigate = (0, _reactRouterDom.useNavigate)();
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              _context.next = 6;
	              return fetch("http://localhost:1234/validateLogin", reqOptions);
	  ...
	  var validateCredentialsThruAxios = function () {
	        ...
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              ...
	              _context2.next = 5;
	              return "/validateLogin", dataToSend;
	    ...
	    return function validateCredentialsThruAxios() {
	        ...
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              ...
	              _context3.next = 5;
	              return fetch("http://localhost:1234/validateToken", reqOptions);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { ref: emailinputRef })
	      ),
	      _react2.default.createElement(
	        'div',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Signup() {
	    ...
	    var passwordinputRef = (0, _react.useRef)();
	    var profilePicinputRef = (0, _react.useRef)();
	    var ageinputRef = (0, _react.useRef)();
	    var genderinputRef = (0, _react.useRef)();
	    var mobileinputRef = (0, _react.useRef)();
	    ...
	    var _useState3 = (0, _react.useState)(""),
	        ...
	        selectedGender = _useState4[0],
	        setSelectedGender = _useState4[1];
	
	    var sendSignupDataToServerFormData = function () {
	        var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
	            var dataToSend, i, reqOptions, JSONData, JSOData;
	            return _regenerator2.default.wrap(function _callee$(_context) {
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        case 0:
	                            ...
	                            _context.next = 12;
	                            return fetch("/signup", reqOptions);
	        ...
	        return function sendSignupDataToServerFormData() {
	            return _ref.apply(this, arguments);
	        };
	    }();
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { ref: ageinputRef })
	            ),
	            _react2.default.createElement(
	                'div',
	                null,
	                ...
	                _react2.default.createElement('input', { ref: genderinputRef, onChange: function onChange() {
	                        setSelectedGender(genderinputRef.current.value);
	                    } }),
	                _react2.default.createElement('input', { type: 'radio', name: 'radio', onChange: function onChange(e) {
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { ref: mobileinputRef })
	            ),
	            _react2.default.createElement(
	                'button',
	                { type: 'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(1),ca=__webpack_require__(30);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
/***/ }
/******/ ])));
//# sourceMappingURL=main.cad75b52.js.map